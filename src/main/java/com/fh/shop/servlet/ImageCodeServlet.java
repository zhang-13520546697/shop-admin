...
public class ImageCodeServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String redisSessionId = DistributedSessionUtil.getSessionId(request, response);
		//将验证码放到redis中
		RedisUtil.setex(KeyUtil.CookieKey(redisSessionId),scode,SystemConstant.COOKIE_CODE_TIMEOUT);
